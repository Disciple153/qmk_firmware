...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        KC_GRV,  KC_1,    KC_2,   KC_3,    KC_4, KC_5, KC_ESC,    KC_DEL,  KC_6,   KC_7, KC_8,    KC_9,   KC_0,    KC_BSPC,
        ...
        KC_LGUI, KC_LALT, KC_SPC, KC_LSFT,                        KC_RSFT, KC_SPC, MO(_MEDIA),    KC_INS,
        KC_MPLY,                                                  KC_MUTE,
                 KC_UP,                                                    KC_UP,
        KC_LEFT, KC_NO,   KC_RGHT,                                KC_LEFT, KC_NO,  KC_RGHT,
                 KC_DOWN,                                                  KC_DOWN
    ),
    [_MEDIA] = LAYOUT(
        KC_F12,  KC_F1,   KC_F2,   KC_F3,   KC_F4,     KC_F5,   _______,                             MO(_ADJUST), KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
    ...
    /*
           ...
           bright,                                                    lcd,
    speed, _____, speed,                                        mode, _____, mode,
           bright,                                                    lcd,
    */
    [_ADJUST] = LAYOUT(
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_MEDIA]  = { ENCODER_CCW_CW(KC_LEFT, KC_RIGHT), ENCODER_CCW_CW(KC_MPRV, KC_MNXT)  },
    [_RGB]    = { ENCODER_CCW_CW(RM_HUED, RM_HUEU),  ENCODER_CCW_CW(RM_SATD, RM_SATU)  },
